...
function getFallbackAssetUrl(key: string): string | undefined {
  const fallbackMap: Record<string, string> = {
    ...
    // Critical characters - using actual Arabic filenames from generated-assets
    'character.narrator': '/generated-assets/characters/الراوي الكوني-التجسيد البصري (Visual Representation).png',
    'character.yahya': '/generated-assets/characters/يحيى الراشد-الصورة الأساسية (Portrait).jpg',
    'character.yahya_breakdown': '/generated-assets/characters/يحيى الراشد-صورة الانهيار (Breakdown Scene).jpg',
    'character.yahya_confront': '/generated-assets/characters/يحيى الراشد-صورة المواجهة (Confrontation Scene).jpg',
    'character.yahya_dying': '/generated-assets/characters/يحيى الراشد-الصورة الأساسية (Portrait).jpg',
    'character.yahya_main': '/generated-assets/characters/يحيى الراشد-الصورة الأساسية (Portrait).jpg',
    'character.laila': '/generated-assets/characters/ليلى حسنالصورة الأساسية (Portrait).jpeg',
    'character.laila_faith': '/generated-assets/characters/ليلى حسن-صورة الإيمان (Faith Portrait).jpg',
    'character.laila_witness': '/generated-assets/characters/ليلى حسن-صورة الشاهدة (Witness Scene — Final Chapter).jpg',
    'character.laila_crying': '/generated-assets/characters/ليلى حسن-صورة الإيمان (Faith Portrait).jpg',
    'character.tarek': '/generated-assets/characters/طارق الراشد-الصورة الأساسية (Portrait).jpg',
    'character.tarek_ghost': '/generated-assets/characters/طارق الراشد-صورة التسجيل (Recording — Ghost Image).jpg',
    'character.tarek_dream': '/generated-assets/characters/طارق الراشد-صورة الحلم (Dream Sequence).jpg',
    'character.first_engineer': '/generated-assets/characters/المهندس الأول-الصورة الأساسية (Portrait).jpeg',
    'character.first_engineer_2': '/generated-assets/characters/المهندس الأول-الصورة الأساسية (Portrait)02.jpeg',
    'character.first_engineer_confront': '/generated-assets/characters/المهندس الأول-صورة المواجهة (Confrontation).jpeg',
    'character.first_engineer_exposed': '/generated-assets/characters/المهندس الأول-صورة الانكشاف (Exposed — Final Scene).jpeg',
    'character.arius': '/generated-assets/characters/آريوس.jpeg',
    'character.athanasius': '/generated-assets/characters/أثناسيوس.jpeg',
    'character.samiri': '/generated-assets/characters/السامري-الصورة الأساسية (Portrait).jpeg',
    'character.samiri_calf': '/generated-assets/characters/السامري-اصورة صناعة العجل (The Golden Calf Scene).png',
    'character.constantine': '/generated-assets/characters/قسطنطين-الصورة الأساسية (Portrait).jpg',
    'character.ramses': '/generated-assets/characters/RAMSIS.jpg',
    'character.abu_abdullah': '/generated-assets/characters/طارق الراشد-الصورة الأساسية (Portrait).jpg',
    'character.dictator': '/generated-assets/characters/المهندس الأول-الصورة الأساسية (Portrait).jpeg',
...
function getFallbackAssetsByKind(kind: string) {
  const allFallbacks = {
    ...
    character: [
      ...
      { key: 'character.yahya', url: '/generated-assets/characters/يحيى الراشد-الصورة الأساسية (Portrait).jpg', mime: 'image/jpeg' },
      { key: 'character.laila', url: '/generated-assets/characters/ليلى حسنالصورة الأساسية (Portrait).jpeg', mime: 'image/jpeg' },
      { key: 'character.tarek', url: '/generated-assets/characters/طارق الراشد-الصورة الأساسية (Portrait).jpg', mime: 'image/jpeg' },
      ...
      { key: 'character.constantine', url: '/generated-assets/characters/قسطنطين-الصورة الأساسية (Portrait).jpg', mime: 'image/jpeg' },
