...
function getFallbackAssetUrl(key: string): string | undefined {
  const fallbackMap: Record<string, string> = {
    ...
    'character.yahya': '/generated-assets/characters/يحيى الراشد-الصورة الأساسية (Portrait).jpeg',
    'character.yahya_breakdown': '/generated-assets/characters/يحيى الراشد-صورة الانهيار (Breakdown Scene).jpeg',
    ...
    'character.tarek': '/generated-assets/characters/طارق الراشد-الصورة الأساسية (Portrait).jpeg',
    'character.tarek_ghost': '/generated-assets/characters/طارق الراشد-صورة التسجيل (Recording — Ghost Image).jpeg',
    'character.tarek_dream': '/generated-assets/characters/طارق الراشد-صورة الحلم (Dream Sequence).jpeg',
    ...
    'character.constantine': '/generated-assets/characters/قسطنطين-الصورة الأساسية (Portrait).jpeg',
    'character.ramses': '/generated-assets/characters/RAMSIS.jpg',
    'character.abu_abdullah': '/generated-assets/characters/طارق الراشد-الصورة الأساسية (Portrait).jpeg',
